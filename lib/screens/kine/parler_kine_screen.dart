...
class _KinesListTab extends StatelessWidget {
  final List<_KineData> _kines = const [
    _KineData(
      nom: 'Dr. Marie Tetuanui',
      specialite: 'Kinésithérapeute • Lombalgie, Cervicalgie',
    ...
    _KineData(
      nom: 'Dr. Jean-Luc Kauaka',
      specialite: 'Kinésithérapeute du sport',
    ...
    _KineData(
      nom: 'Dr. Sophie Wambé',
      specialite: 'Rééducation post-op, Arthrose',
    ...
    _KineData(
      nom: 'Dr. Hiro Teriitehau',
      specialite: 'Kinésithérapie respiratoire, Bien-être',
    ...
    _KineData(
      nom: 'Dr. Amina Naïssa',
      specialite: 'Sciatique, Hernie discale, Tendinite',
      localisation: 'Papeete, Polynésie française',
      disponible: false,
      experience: '10 ans',
      emoji: '👩‍⚕️',
      langues: ['Français'],
      tarif: '4 200 XPF / consultation',
      note: 5.0,
    ),
  ];
